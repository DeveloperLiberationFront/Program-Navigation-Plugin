...
Those methods reside in other class files, so \toolName~ provides links to their locations (C).
Rather than move your mouse up to the top of the editor window, you click on \texttt{getQueries} (B), which conveniently links to the first call site. 
