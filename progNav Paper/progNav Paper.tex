...
For Task 1, all participants correctly navigated up the call graph and did so faster with \toolName~ compared to the Eclipse tools.
With \toolName, participants' mean completion time was 276 seconds, compared to 402 seconds with the Eclipse tools.
...
However, the mean completion time for Task 2 with \toolName~was higher (385 seconds) compared to the Eclipse tools (251 seconds).
