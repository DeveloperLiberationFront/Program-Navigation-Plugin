...
%\rowcolor{gray!50}
\hline
Participant & \multicolumn{1}{c|}{Industry} & \multicolumn{1}{c|}{Java} &\multicolumn{1}{c|}{Used} & Task \\
%\rowcolor{gray!50}
& \multicolumn{1}{c|}{Exp. (years)} & \multicolumn{1}{c|}{Exp. (years)} & \multicolumn{1}{c|}{Eclipse} & Group\\
\hline
