...
There are a variety of tools available to help developers explore and navigate code. Here we discuss two types of tools, production tools and visualization tools and Table \ref{table:background} shows a comparison between \toolName~ and other related tools in terms of the four design principles used to design our tool.
...
\toolName~ opens \texttt{createTables} and highlights the location in that method where \texttt{fileName} passed to \texttt{getQueries} as seen in Fig. \ref{fig:tool}.  
