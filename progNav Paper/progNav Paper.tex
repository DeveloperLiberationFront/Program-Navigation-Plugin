...
However they generally differ from Flower  in that they lack \textit{Low Barriers to Invocation} and \textit{In Situ Navigation}.
...
We performed a preliminary evaluation of Flower  with eight programmers performing two code navigation tasks.
