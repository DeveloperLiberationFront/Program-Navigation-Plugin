...
%\rowcolor{gray!50}
\hline
Participant & \multicolumn{1}{c|}{Industry} & \multicolumn{1}{c|}{Java} &\multicolumn{1}{c|}{Used} & Group \\
%\rowcolor{gray!50}
& \multicolumn{1}{c|}{Exp. (years)} & \multicolumn{1}{c|}{Exp. (years)} & \multicolumn{1}{c|}{Eclipse} & \\
\hline
P1 & 9 & 5 & \checkmark & 1 \\
\hline
P2 & 0 & 6 & \checkmark & 2\\
...
P4 & 5 & 0 & - & 4\\
\hline
P5 & 12 & 10 & \checkmark & 1\\
\hline
P6 & 0 & 3.5 & \checkmark & 2\\
\hline
P7 & 1 & 9 & \checkmark & 3\\
\hline
P8 & 5.5 & 3.5 & \checkmark & 4\\
\hline
\end{tabular}
