...
We evaluated \textit{Flower}, to better understand what types of tasks it effectively supports. 
Our preliminary findings failed to identify any significant differences between \textit{Flower} and more complex navigation tools within Eclipse. 
This suggests that the simple affordances \textit{Flower} implements may sufficiently aide developers.
