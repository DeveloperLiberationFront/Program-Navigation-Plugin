 ...
 * Originally intended to extend OccurrencesFinder but that didn't work for the moment,
 * will eventually go through and remove unneeded code from OccurrencesFinder.
 * 
 * @author Chris
 *
 */
public class DeclarationFinder extends OccurrencesFinder {
	...
	public OccurrenceLocation[] getUpOccurrences() {
		//TODO search only for variable declarations and initializations
		return getOccurrences();
	}
	
	public CompilationUnit getCompUnit(String source) {
